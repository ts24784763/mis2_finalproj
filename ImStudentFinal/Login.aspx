    ...
    <form id="form1" runat="server">
        ...
        <div id="loginRight">
            ...
            <div class="auto-style3">
                ...
                <asp:RequiredFieldValidator ID="emailValidator" runat="server" ErrorMessage="請輸入信箱" ForeColor="#CC0000" ControlToValidate="txtEmail"></asp:RequiredFieldValidator>
                <br />
                ...
                <asp:RequiredFieldValidator ID="passwordValidator" runat="server" ErrorMessage="請輸入密碼" ControlToValidate="txtPassword" ForeColor="#CC0000"></asp:RequiredFieldValidator>
                <br />
                <asp:Button id="btnLogin" class="auto-style5" runat="server" Text="登入" CausesValidation="true" OnClick="btnLogin_Click" Height="32px" Width="283px"></asp:Button>
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
